...
;
;   Lab number:         5
;   Title:              Display input character on LCD.
;
;   Hardware:           STK600, CPU ATmega2560
;
;   Function:           Displays character received on a serial port.
;
;   Input ports:        RX on PINE0 and PINE1
;
;   Output ports:       LCD on PORTB
;
;   Subroutines:        rx_interrupt,
;                       loop,
...
;>>>>>>>>>>>>>>>>Ser prescaller value, enable receiver>
	ldi temp, UBRR_val
	sts UBRR0L, temp ;store prescaler value in UBRRL
	ldi temp, (1<<RXEN0) | (1<<RXCIE0)
	sts UCSR0B, temp ;set RX enable flags
